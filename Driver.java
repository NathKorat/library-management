...
//Library.Management.Driver drives the Library.Management.Library System. It gives IO interface to use and control Library.Management.Library!

	Scanner sc;					// 	to scan user input initialized in main function.
	Library myLibrary;		//	Library.Management.Library instant initialized in main function.

			//Constructor for Library.Management.Driver
	...
	void loginIO(int type){
		...
		String name,pass;
		// template is the option list for Library.Management.Admin interface!
		...
		//If some Library.Management.Faculty or Library.Management.Student logs in with correct username and password, and is not Library.Management.Admin,
		...
		//For Library.Management.Admin Login IO Interface!
		...
		// For Library.Management.Faculty and Library.Management.Student Login IO Interface.
		else{
			String template_2 = "\n\nChoose from the following options:\n\n"+
	...
	/*****************************************/
	void addUserIO(Admin admin,int type){		//Only Library.Management.Admin is allowed to enter this method!
		
		//This function takes the userName and password of the new user and calls addUser function of Library.Management.Admin
	...
	void removeUserIO(Admin admin){
		...
		// This function asks for the ID or userName of user to be deleted and calls removeUser function of Library.Management.Admin...
	...
	void addResourceIO(Admin admin, int type){
		...
		//This function asks for the Name of the Resource to be Added and calls addResource function of Library.Management.Admin.Java...
	...
	void borrowIO(Borrower borrower, int type){
		...
		// This function asks for the name or ID of the resource to be borrowed and calls tryIssue function of the Library.Management.Borrower.java
		ArrayList<LibraryResource> resources = new ArrayList<LibraryResource>();
		String name;
		int id = -1;
	...
	void returnResourceIO(Borrower borrower){
		...
		// This function asks for the name or ID of the resource to be returned and calls tryReturn function of the Library.Management.Borrower.java
		ArrayList<LibraryResource> resources = new ArrayList<LibraryResource>();
		String name;
		int id = -1;
		System.out.println("Enter the name or ID of resource:");
	...
	void deleteRequestIO(Borrower borrower){
		...
		// This function asks for the name or ID of resource of which request is to be deleted and calls withdrawRequest of Library.Management.Borrower.Java...
		ArrayList<LibraryResource> resources = new ArrayList<LibraryResource>();
		int id = -1;;
		String name;
	...
	void renewResourceIO(Borrower borrower){
		...
		// This function asks for the name or ID of resource to be renewed and calls tryRenew of Library.Management.Borrower.Java...
		ArrayList<LibraryResource> resources = new ArrayList<LibraryResource>();
		int id = -1;;
		String name;
	...
	public static void main(String[] argv){
		...
		String libName = "LUMS Library.Management.Library";
		
		Driver driver = new Driver(libName);
		
		System.out.println("\n\n***Welcome to Library.Management.Library Management System***\n\nSelect from the following options:\n\n" +
		...
		// Taking the user input and appropriately calling functions... Main IO interface for Library.Management.Library
		while(!done){
