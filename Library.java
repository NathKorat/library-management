...
public class Library implements LibraryInfo {
	...
	// The IDs for resources ... They are kept unique and accessed using Library.Management.Library class
    ...
    /**
     * This will keep the record of all the library system users (Students, Library.Management.Faculty, Library.Management.Admin) in it
     */
    public ArrayList<LibraryUser> users;

    /**
     * The constructor of the Library.Management.Library Class
     */
    private Library(String name) {
         ...
         * NOTE: Whenever a new user is initiallized, its pointer is added to the <b>user</b> array of the Library.Management.Library class to keep track of it
         * your methods should add the users to this array whenever a new user is initiallized
         */
        Admin admin = new Admin("admin", "123", Constants.ADMIN,true);
	...
	/**
	*Singleton class necessary for one instance of Library.Management.Library..This concept was explained in the lecture.
	*/
	...
	public void getLibraryStats(){
		...
		System.out.println("\t\t\t\t*** Library.Management.Library System Stats ***\n\nNo. of Users:\t" + users.size());
		System.out.println("\tAdministrators: " + admin + "\n\tLibrary.Management.Faculty: " + faculty + "\n\tStudents: " + students);
	...
	/*******************************************/
	/*****Library.Management.Library users search functions********/
	/*******************************************/
	...
	/*******************************************/
	/*******Library.Management.Library user removal function*******/
	/*******************************************/
	...
	void updateFines(){
		...
		//Updates Fines by checking the list kept by Library.Management.Library (Set<Library.Management.Fine> toBeFined).
	...
	//removes Library.Management.Fine(s) from toBeFined if they are returned!
	...
	//adds Library.Management.Fine to toBeChecked collection
		if(!toBeFined.contains(fine)){
			toBeFined.add(fine);
			return true;
		}
